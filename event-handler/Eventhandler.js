...
class Eventhandler {
    ...
    constructor(instance, events, client) {
        ...
        this._builtInEvents = {
            interactionCreate: {
                ...
                isCommand: (interaction) => interaction.type === InteractionType.ApplicationCommand || interaction.type === InteractionType.ApplicationCommandAutocomplete,
            },
            messageCreate: {
    ...
    registerEvents() {
        ...
        console.info(chalk.green`Loaded ${i} events`)
    }
